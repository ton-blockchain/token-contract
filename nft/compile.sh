...
func -o build/nft-item-editable-code.fif -SPA stdlib.fc op-codes.fc nft-item-editable-DRAFT.fc
func -o build/nft-collection-code.fif -SPA stdlib.fc op-codes.fc nft-collection.fc
func -o build/nft-collection-editable-code.fif -SPA stdlib.fc op-codes.fc nft-collection-editable.fc
